  ...
  return (
    <>
      <div className="container">
            <div className="row">
              <div className="col-lg-4 col-md-1 d-lg-block d-md-none d-sm-none"></div>
              <div className="col-lg-4">
                <img src={myImages.logo} className="p-2 text-center img-fluid mx-auto" height='100px'/>
              </div>
              <div className="col-lg-4 col-md-4 d-flex gap-3 flex-row align-items-center justify-content-end">
                  <div>
          ...
          <div class="modal-dialog modal-fullscreen modal-dialog-centered">
            <div class="modal-content ">
              ...
              <div class="modal-body">
                ...
                <input type="text" name="" placeholder='Search Products' className='form-control border-bottom border-0' />
      ...
      <nav className='navbar navbar-expand-lg'>
        <div className="container">
          <button className='navbar-toggler' type='button' 
                  data-bs-toggle='collapse' data-bs-target="#modNavbar">
                <span className="navbar-toggler-icon"></span>
          </button>
          <div className="collapse navbar-collapse justify-content-center" id="modNavbar">
...
{/* <div className="container d-flex flex-column">
        <div className="row">
          <div className="col">
            <div className="emptyspace col-lg-4"></div>
          </div>
          <div className="col">
            <div className="align-items-center">
              <br /><br />
              <img src={myImages.logo} height='100px' width='' alt="" />
            </div>
          </div>
          <div className="col d-flex gap-3 flex-row align-items-center justify-content-end">
            <div>
              <svg onClick = {()=> alert('hello')} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
                <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6m2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0m4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4m-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10s-3.516.68-4.168 1.332c-.678.678-.83 1.418-.832 1.664z"/>
              </svg>
            </div>
            <div>
        ...
        <br /><br />
        <div className="row">
          <div className="navbar gap-5 flex-fill justify-content-center">
            <Link className='text-decoration-none text-dark' to="/">Home</Link>
            <Link className='text-decoration-none text-dark' to="/about">About</Link>
            <Link className='text-decoration-none text-dark' to="/shop">Shop</Link>
